...
export default function AvaliarAlbum() {
    return (
        <>
            <a href="#rating-modal-container" className="button-style">Avaliar o Álbum</a>
            <div id="rating-modal-container">
                <div className="modal-content">
                    ...
                    <div className="modal-buttons">
                        ...
                        <a href="#" className="button-style rate-btn">Avaliar</a>
                    </div>
                </div>
            </div>
        </>
